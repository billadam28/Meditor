<header id="header">
	...
	<section id="secondary_bar">
		...
		<h3>Doctors</h3>
		<ul class="toggle">
                    <li class="icn_search"><a href="SearchDocSrvlt" onclick="highlightCurrentLink();">Search or Edit info</a></li>
			<li class="icn_add_user" onclick="highlightCurrentLink();"><a href="addDoctSrvlt">Create new</a></li>
		</ul>
